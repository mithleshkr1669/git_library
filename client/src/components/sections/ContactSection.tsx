...
const ContactSection = () => {
  ...
  const whatsappNumber = "+916206735381";
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4">
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer">
                  <Button className="w-full bg-green-600 hover:bg-green-700 text-white font-medium flex items-center justify-center gap-2">
